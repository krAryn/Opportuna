  ...
  return company
    ? (
      <div className='min-h-screen'>
        <div className='shadow py-4 h-[77px]'>
        ...
        <div className='flex items-start h-screen rec-db-sec'>
          <div className='inline-block border-r-2 border-gray-200 sm:min-w-[210px] rec-db-sec'>
          ...
          <div className='w-full overflow-auto rec-db-sec'>
