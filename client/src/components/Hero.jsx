  ...
  return (
    <div className='container px-10 lg:px-20 w-[100vw] max-w-[1500px] m-auto my-10'>
        <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center rounded-xl px-4'>
            ...
            <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 sm:mx-auto gap-1'>
                ...
                <button onClick={handleSubmit} className='bg-primary cursor-pointer hover:bg-primary-dull px-6 py-2 rounded text-white m-1'>Search</button>
            </div>
        </div>
